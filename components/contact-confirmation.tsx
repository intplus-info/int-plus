      ...
      <div className="mx-auto space-y-12">
        ...
        >
          ...
          <div className="flex justify-center gap-6 py-4">
            <Link target='_blank' href="https://www.linkedin.com/company/intplus" className="hover:text-gray-300 transition-colors">
              <motion.div whileHover={{ scale: 1.1 }}>
                <Linkedin className="w-6 h-6" />
              </motion.div>
              <span className="sr-only">LinkedIn</span>
            </Link>
            <Link target='_blank' href="https://www.instagram.com/intplus_technology" className="hover:text-gray-300 transition-colors">
              <motion.div whileHover={{ scale: 1.1 }}>
                <Instagram className="w-6 h-6" />
              </motion.div>
              <span className="sr-only">Instagram</span>
            </Link>
            <Link target='_blank' href="https://x.com/info_intplus" className="hover:text-gray-300 transition-colors">
              <motion.div whileHover={{ scale: 1.1 }}>
