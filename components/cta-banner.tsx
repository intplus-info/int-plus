    ...
    <section className="bg-background text-white py-16 px-4 rounded-t-[25px] min-h-[600px] md:min-h-[500px] bg-[url('/bg-small.svg')] relative border-t flex items-center justify-center">
      <div className=" mx-auto text-center flex items-center justify-center w-full absolute z-20 pt-10">
        <div className="container mx-auto">
          <h2 className="title mb-6">Ready to Improve Your Business Productive?</h2>
          <p className="text-muted-foreground mb-8 mx-auto">
            Take the first step towards digital success with Int+ by your side. Our team of experts
            is eager to craft tailored solutions that drive growth for your business. Whether you
            need a stunning website, a powerful mobile app, or a robust enterprise solution,
