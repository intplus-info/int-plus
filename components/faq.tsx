...
export default function FAQ() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        'We employ a comprehensive approach including SEO, content marketing, social media optimization, and targeted advertising to drive quality traffic to your website.',
    },
    {
      ...
      answer: (
        <>
          ...
          <ol className="list-decimal pl-5 mt-2 space-y-1">
            <li>
              Requirements Gathering: We gather and analyze your requirements to define the scope of
              the project.
            </li>
            <li>
              Design: We create a detailed design of the software, including architecture, user
              interface, and database design.
            </li>
            <li>
              Development: We develop the software using the chosen technology stack and coding
              standards.
            </li>
            <li>
              Testing: We conduct rigorous testing to ensure the quality and functionality of the
              software.
            </li>
            <li>
              Deployment: We deploy the software to your environment and provide training and
              support.
            </li>
            <li>
              Maintenance: We provide ongoing maintenance and support to ensure the smooth operation
              of the software.
            </li>
          </ol>
        </>
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <ol className="list-decimal pl-5 mt-2 space-y-1">
            <li>
              Initial Consultation: We meet with you to understand your business needs and project
              requirements.
            </li>
            <li>
              Project Proposal: We provide you with a detailed proposal outlining the scope of work,
              timelines, and costs.
            </li>
            <li>
              Project Kickoff: We hold a kickoff meeting to introduce the project team and discuss
              the project plan.
            </li>
            <li>
              Development and Testing: We follow an Agile development process with regular sprints
              and feedback loops.
            </li>
            <li>
              Deployment and Support: We deploy the software to your environment and provide ongoing
    ...
    },
    {
      ...
      answer:
        'We implement industry-standard security measures, including encryption, secure authentication, and regular security audits to protect user data.',
    },
    {
      question: 'How do you ensure cross-platform compatibility for mobile apps?',
      answer:
        'We use modern cross-platform development frameworks and conduct thorough testing across different devices and operating systems.',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">
            ...
            to find valuable insights into our processes, pricing, and more. Transparency is at the
            core of our client interactions.
          </p>
        </motion.div>
