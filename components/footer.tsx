...
export default function Footer({ logo, socialLinks, sections, copyright, version, policies }: FooterProps) {
  return (
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <Link key={index} href={social.href} className="hover:text-gray-300 hover:translate-y-2 hover:shadow-md hover:shadow-accent-foreground/20 rounded-full transition-all ease-in-out duration-300">
                  <Image
                    src={social.icon}
                    alt={social.alt}
                    width={48}
