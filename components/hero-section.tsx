...
export function HeroSection() {
  ...
  return (
    <section className="lg:h-[50vh] xl:h-[85vh] flex items-center justify-center py-10 md:pt-20">
      <div className="flex flex-col items-center text-center space-y-8 w-full">
        <div className="space-y-4 w-full container px-4">
          <h1 className="text-[34px] md:text-5xl font-semibold leading-[44px] xl:tracking-tighter">
            Software Solutions{" "} <br className="md:hidden" />
            <span className="text-muted-foreground">For Your Business Growth</span>
          </h1>
          <p className="mx-auto text-muted-foreground pt-8 leading-[21px]">
        ...
        <div className="w-full">
          ...
          <div className="hidden lg:flex items-center gap-8 w-fit mx-auto">
            {industries.map((industry) => (
